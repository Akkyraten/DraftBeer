...
async def start(update: Update, context):
    ...
    keyboard = [
        [InlineKeyboardButton("🍺 Каталог пива", callback_data="beer_catalog")],
        [InlineKeyboardButton("🦞 Раки и икра", callback_data="seafood_catalog")],
        [InlineKeyboardButton("🎉 Вечеринки", callback_data="events")],
...
async def button_handler(update: Update, context):
    ...
    if data == "beer_catalog":
        ...
        await query.message.reply_text("🚚 Для доставки укажите адрес и время.")
    elif data == "contact":
